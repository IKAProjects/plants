...
class _AddPlantScreenState extends State<AddPlantScreen> {
  ...
  Widget build(BuildContext context) {
    String displayText =
        _selectedTemperature != null ? '$_selectedTemperature °C ' : '25 °C';
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              TemperatureButton(
                ...
                textColor: _selectedTemperature != null
                    ? Colors.white
      ...
      floatingActionButton: AppButton(
        onPressed: () {
          if (isFilled) {
            ...
            final addPlant = PlantModel(
              name: _plantNameController.text,
              description: _plantDescriptionController.text,
              image: _image?.path,
              temperature: _selectedTemperature ?? 20,
              humidity: plantHumidity ?? PlantHumidity.values.first,
              id: plantId, isFavorite: false,
            );
            context.read<PlantBloc>().add(AddPlant(addPlant));
